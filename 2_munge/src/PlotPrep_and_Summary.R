##This script munges our Mendota data to prep it for Figure 1 and then
##outputs a text summary of the results
...
summaryOut <- function(eval_data, project_output_dir, file_name){
  ...
  template_1 <- 'Models resulted in mean RMSEs (means calculated as average of RMSEs from the five dataset iterations) of {{pgdl_980mean}}, {{dl_980mean}}, and {{pb_980mean}}°C for the PGDL, DL, and PB models, respectively.
